Public Class formadmin
    ...
    Private Function ValiderChamps() As Boolean
        If String.IsNullOrWhiteSpace(txt_num.Text) OrElse
           ...
           String.IsNullOrWhiteSpace(txt_nbp.Text) OrElse
           String.IsNullOrWhiteSpace(txt_prix.Text) Then
            MessageBox.Show("Veuillez remplir tous les champs.", "Erreur", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Return False
        End If

        If Not Integer.TryParse(txt_num.Text, Nothing) OrElse Not Integer.TryParse(txt_nbp.Text, Nothing) Then
    ...
    Private Sub btn_ajout_Click(sender As Object, e As EventArgs) Handles btn_ajout.Click
        ...
        Dim nouveauVol As New Vol With {
            ...
            .PlacesDisponibles = Integer.Parse(txt_nbp.Text),
    ...
    Private Sub btn_deconnexion_Click(sender As Object, e As EventArgs) Handles btn_deconnexion.Click
        Dim formgestion As New formgestion()
        formgestion.Show()
        Me.Close()
    End Sub
End Class